...
y4 <- which(dat1$month=="2022-09")##Remove September 2022 since there is a high number of missing values for lineage diversity
dat1 <-dat1[-c(y1,y2,y3,y4),]

data <- dat1

dir.create("02_fig/main_fig2-3")
outpath <-  "02_fig/main_fig2-3/main"

source('002.load-data-cb-function.R')#Run the function to construct cross-basis functions
...
#cp_travel_si1 <- crosspred(travel_si_cb, model_si, cen=0,at=0:15000/1000,by=0.1,bylag=0.1,cumul=TRUE) #slices
...
#r_l <- cp_travel_si1$cumlow["1.635","lag3"]/si_m 
#r_f <- cp_travel_si1$cumfit["1.635","lag3"]/si_m 
#r_h <- cp_travel_si1$cumhigh["1.635","lag3"]/si_m 

#0.09753737/si_m 
pdf(file=paste0(outpath,"_fig2.pdf"), width = 21, height = 14.5)
#pdf("02_fig/fig2.pdf", width = 21, height = 21/3*2)

par(mfrow=c(2,3),mar = c(8, 8, 5, 3),oma = c(0, 2, 0, 0))
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-3, 2), frame.plot = F, axes = F,family = "ArialN",cex.lab=3,line =5)
axis(1,at=0:5*3,cex.axis=3,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*1,2:0*1),cex.axis=3,family = "ArialN",mgp=c(3,1,0))
...
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases \nand lineage diversity",side = 2,at=-0.5, line =4,cex=2,family = "ArialN")
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-3, 1), frame.plot = F, axes = F,family = "ArialN",cex.lab=3,line =5)
axis(1,at=0:5*3,cex.axis=3,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*1,1:0*1),cex.axis=3,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases \nand lineage diversity",side = 2,at=-1, line =4,cex=2,family = "ArialN")
...
legend("bottomleft",
       ...
       lwd = 3, lty = 1, bty = "n", 
       y.intersp = 1.5, horiz = F,cex=2.5)
mtext(side = 2, at = 1.32, text = "B", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-5,20), frame.plot = F, axes = F,family = "ArialN",cex.lab=3,line =5)
axis(1,at=0:5*3,cex.axis=3,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-1:0*5,4:0*5),cex.axis=3,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases \nand lineage diversity",side = 2,at=7.5, line =4,cex=2,family = "ArialN")
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-3, 0), frame.plot = F, axes = F,family = "ArialN",cex.lab=3,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=3,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*1),cex.axis=3,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases \nand lineage diversity",side = 2,at=-1.5, line =4,cex=2,family = "ArialN")
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "Stringency index", ylab = "", main = "", 
     ylim = range(-15, 0), frame.plot = F, axes = F,family = "ArialN",cex.lab=3,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=3,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*5),cex.axis=3,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
#    lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.5)
mtext(side = 2, at = 1.72, text = "F", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
mytheme <- theme_bw()+
  theme(
    ...
    axis.title.y.left = element_text(size = 22,color="black",vjust=2),
    axis.title.y.right =element_text(size = 22,color="black",vjust=0,angle=90),
    axis.title.x = element_text(size = 22, color="black",vjust = -0.5),
    axis.text.y.left = element_text(size = 22,color="black",vjust = 0,angle = 0),
    axis.text.y.right = element_text(size = 22,color="black",vjust = 0,angle = 0),
    axis.text.x = element_text(size = 22, color="black",vjust = 0.5, angle = 0),
...
write.csv(result_vero_shannon,file=paste0(outpath,"_vero_shannon",".csv"),row.names =F)
...
p1  <- ggplot(result_vero_shannon,aes(x=coverage, y=vero_fit,group=coverage))+ 
  geom_point(aes(x=coverage,y=vero_fit,color=coverage),position=position_dodge(0.5),size=8,alpha=0.7)+
  ...
  labs(x="Adjusted vaccine coverage (%)", y= "Effect on lineage diversty" )+  
  geom_hline(aes(yintercept=0),lty='dashed',colour ="black",size=0.5)+
  scale_color_manual(name = 'Adjusted vaccine coverage',values = c("#ED0000FF","#ED0000FF","#ED0000FF"))+ 
  scale_y_continuous(limits = c(-1.0,0.5),breaks = c(-1,-0.5,0,0.5))+
  mytheme+
  theme(axis.line.x = element_line(color="black", size = 0.8),axis.line.y = element_line(color="black", size = 0.8))

p1

#ggsave(file=paste0(outpath,"_fig3-b",".pdf"),
...
result_vero_shannon_gr$coverage <-factor(result_vero_shannon_gr$coverage,levels= c('Low (25)','Medium (50)','High (75)',
                                           ordered=TRUE))
write.csv(result_vero_shannon_gr,file=paste0(outpath,"_vero_growth_rate",".csv"),row.names =F)
...
p2  <- ggplot(result_vero_shannon_gr,aes(x=coverage, y=vero_fit,group=coverage))+ 
  ...
  geom_hline(aes(yintercept=0),lty='dashed',colour ="black",size=0.5)+
  scale_color_manual(name = 'Adjusted vaccine coverage',values = c("#00468BFF","#00468BFF","#00468BFF"))+ 
  scale_y_continuous(limits = c(-3,0),breaks = c(-3,-2,-1,0))+
  mytheme+
  theme(axis.line.x = element_line(color="black", size = 0.8),axis.line.y = element_line(color="black", size = 0.8))

p2

#ggsave(file=paste0(outpath,"_fig3-a",".pdf"),
#       p2,width = 7.2,height =7.2)




p<-ggarrange(p2, p1,ncol =2, nrow = 1,widths = c(1,1),heights = c(1,1),
...
ggsave(file=paste0(outpath,"_fig3",".pdf"),
       p,width = 16,height =8)




vero_low <- cp_FI_si_rich$cumlow["75","lag1"]
vero_fit <- cp_FI_si_rich$cumfit["75","lag1"]
vero_high <- cp_FI_si_rich$cumhigh["75","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
...
vero_low <- cp_FI_si_rich$cumlow["50","lag1"]
vero_fit <- cp_FI_si_rich$cumfit["50","lag1"]
vero_high <- cp_FI_si_rich$cumhigh["50","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <-  "Richness"
...
vero_low <- cp_FI_si_rich$cumlow["25","lag1"]
vero_fit <- cp_FI_si_rich$cumfit["25","lag1"]
vero_high <- cp_FI_si_rich$cumhigh["25","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <- "Richness"
...
result_vero_rich <- result_vero
result_vero_rich$coverage <-factor(result_vero_rich$coverage,levels= c('Low (25)','Medium (50)','High (75)',
                                                                                   ordered=TRUE))

p3  <- ggplot(result_vero_rich,aes(x=coverage, y=vero_fit,group=coverage))+ 
  geom_point(aes(x=coverage,y=vero_fit,color=coverage),position=position_dodge(0.5),size=8,alpha=0.7)+
  geom_errorbar(aes(x=coverage, y=vero_fit,ymin=vero_low,ymax=vero_high,color=coverage),
                width=0.2,stat="identity",position = position_dodge(0.5),lwd=0.6)+
  #facet_wrap(~Type,scales = "free",nrow = 1)+
  labs(x="Adjusted vaccine coverage (%)", y= "Effect on lineage diversty" )+  
  geom_hline(aes(yintercept=0),lty='dashed',colour ="black",size=0.5)+
  scale_color_manual(name = 'Adjusted vaccine coverage',values = c("#E18727B2","#E18727B2","#E18727B2"))+ 
  scale_y_continuous(limits = c(-24,12),breaks = c(-24,-12,0,12))+
  mytheme+
  theme(axis.line.x = element_line(color="black", size = 0.8),axis.line.y = element_line(color="black", size = 0.8))
...
#ggsave(file=paste0(outpath,"_fig16-richness-a2",".pdf"),
#       p3,width = 7.2,height =7.2)



vero_low <- cp_FI_si_even$cumlow["75","lag1"]
vero_fit <- cp_FI_si_even$cumfit["75","lag1"]
vero_high <- cp_FI_si_even$cumhigh["75","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <-  "Evenness"
result$coverage1 <- "75"
result$coverage <- "High (75)"
result_vero_75 <- result 

vero_low <- cp_FI_si_even$cumlow["50","lag1"]
vero_fit <- cp_FI_si_even$cumfit["50","lag1"]
vero_high <- cp_FI_si_even$cumhigh["50","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <-  "Evenness"
...
vero_low <- cp_FI_si_even$cumlow["25","lag1"]
vero_fit <- cp_FI_si_even$cumfit["25","lag1"]
vero_high <- cp_FI_si_even$cumhigh["25","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <- "Evenness"
...
result_vero_even <- result_vero


result_vero_even$coverage <-factor(result_vero_even$coverage,levels= c('Low (25)','Medium (50)','High (75)',
                                                                       ordered=TRUE))
rev(brewer.pal(9, "YlGn"))

p4  <- ggplot(result_vero_even,aes(x=coverage, y=vero_fit,group=coverage))+ 
  geom_point(aes(x=coverage,y=vero_fit,color=coverage),position=position_dodge(0.5),size=8,alpha=0.7)+
  geom_errorbar(aes(x=coverage, y=vero_fit,ymin=vero_low,ymax=vero_high,color=coverage),
                width=0.2,stat="identity",position = position_dodge(0.5),lwd=0.6)+
  #facet_wrap(~Type,scales = "free",nrow = 1)+
  labs(x="Adjusted vaccine coverage (%)", y= "Effect on lineage diversty" )+  
  geom_hline(aes(yintercept=0),lty='dashed',colour ="black",size=0.5)+
  scale_color_manual(name = 'Adjusted vaccine coverage',values = c("seagreen" ,"seagreen" ,"seagreen"  ))+ 
  scale_y_continuous(limits = c(-0.4,0.2),breaks = c(-0.4,-0.2,0,0.2))+
  mytheme+
  theme(axis.line.x = element_line(color="black", size = 0.8),axis.line.y = element_line(color="black", size = 0.8))

p4
#ggsave(file=paste0(outpath,"_fig16-evenness-b2",".pdf"),
#       p4,width = 7.2,height =7.2)




vero_low <- cp_FI_gr_rich$cumlow["75","lag1"]
vero_fit <- cp_FI_gr_rich$cumfit["75","lag1"]
vero_high <- cp_FI_gr_rich$cumhigh["75","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <-  "Richness"
...
vero_low <- cp_FI_gr_rich$cumlow["50","lag1"]
vero_fit <- cp_FI_gr_rich$cumfit["50","lag1"]
vero_high <- cp_FI_gr_rich$cumhigh["50","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <-  "Richness"
...
vero_low <- cp_FI_gr_rich$cumlow["25","lag1"]
vero_fit <- cp_FI_gr_rich$cumfit["25","lag1"]
vero_high <- cp_FI_gr_rich$cumhigh["25","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <- "Richness"
...
result_vero <- rbind(result_vero_25,result_vero_50,result_vero_75)
result_vero$Lag <- "lag1"
result_vero_rich_gr <- result_vero
result_vero_rich_gr$coverage <-factor(result_vero_rich_gr$coverage,levels= c('Low (25)','Medium (50)','High (75)',
                                                                       ordered=TRUE))

p5  <- ggplot(result_vero_rich_gr,aes(x=coverage, y=vero_fit,group=coverage))+ 
  geom_point(aes(x=coverage,y=vero_fit,color=coverage),position=position_dodge(0.5),size=8,alpha=0.7)+
  geom_errorbar(aes(x=coverage, y=vero_fit,ymin=vero_low,ymax=vero_high,color=coverage),
                width=0.2,stat="identity",position = position_dodge(0.5),lwd=0.6)+
  #facet_wrap(~Type,scales = "free",nrow = 1)+
...
#ggsave(file=paste0(outpath,"_fig16-richness-a1",".pdf"),
#       p5,width = 7.2,height =7.2)





vero_low <- cp_FI_gr_even$cumlow["75","lag1"]
vero_fit <- cp_FI_gr_even$cumfit["75","lag1"]
vero_high <- cp_FI_gr_even$cumhigh["75","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <-  "Evenness"
...
vero_low <- cp_FI_gr_even$cumlow["50","lag1"]
vero_fit <- cp_FI_gr_even$cumfit["50","lag1"]
vero_high <- cp_FI_gr_even$cumhigh["50","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <-  "Evenness"
...
vero_low <- cp_FI_gr_even$cumlow["25","lag1"]
vero_fit <- cp_FI_gr_even$cumfit["25","lag1"]
vero_high <- cp_FI_gr_even$cumhigh["25","lag1"]
result <- cbind(vero_low,vero_fit,vero_high)
result <- as.data.frame(result)
result$Lag <- rownames(result)
result$Type <- "Evenness"
...
result_vero_even_gr <- result_vero

result_vero_even_gr$coverage <-factor(result_vero_even_gr$coverage,levels= c('Low (25)','Medium (50)','High (75)',
                                                                             ordered=TRUE))

p6  <- ggplot(result_vero_even_gr,aes(x=coverage, y=vero_fit,group=coverage))+ 
  geom_point(aes(x=coverage,y=vero_fit,color=coverage),position=position_dodge(0.5),size=8,alpha=0.7)+
  geom_errorbar(aes(x=coverage, y=vero_fit,ymin=vero_low,ymax=vero_high,color=coverage),
                width=0.2,stat="identity",position = position_dodge(0.5),lwd=0.6)+
  #facet_wrap(~Type,scales = "free",nrow = 1)+
...
#ggsave(file=paste0(outpath,"_fig16-evenness-b1",".pdf"),
#       p6,width = 7.2,height =7.2)



ps<-ggarrange(p2,p6,p5,p1,p4,p3, ncol =3, nrow = 2, widths = c(1,1),heights = c(1,1),
              labels = c("A","B", "C", "","",""),  vjust=1.3,align = "hv",
              #common.legend=TRUE,legend = "bottom",
              font.label = list(size = 24))
ps

ggsave(file=paste0(outpath,"_fig3",".pdf"),
       ps,width = 21, height = 14)
