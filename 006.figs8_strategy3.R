...
#Rename the Shannon's index of lineage diversity data, calculated based on subsampling strategy 3, as "sub_lineage"
colnames(dat1)[23] <- "sub_lineage" 

#Rename the richness of lineage diversity data, calculated based on subsampling strategy 3, as "sub_richness"
colnames(dat1)[24] <- "sub_richness" 

#Rename the evenness of lineage diversity data, calculated based on subsampling strategy 3, as "sub_evenness"
colnames(dat1)[25] <- "sub_evenness" 
...
dir.create("02_fig/figs8_strategy3")
outpath <-  "02_fig/figs8_strategy3/strategy3-figs8"
...
Y2  <- data$sub_lineage # response variable (Shannon's index of lineage diversity based on the subsampling strategy 3)
Y3  <- data$sub_richness # response variable (the richness of lineage diversity based on the subsampling strategy 3)
Y4  <- data$sub_evenness # response variable (the evenness of lineage diversity based on the subsampling strategy 3)
...
#pdf("02_fig/figs7-2500-a-f.pdf", width = 21, height = 21/3*2)
pdf(file=paste0(outpath,"-2500-a-f.pdf"), width = 21, height = 21/3*2)
...
#    lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 5.5, text = "F", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
