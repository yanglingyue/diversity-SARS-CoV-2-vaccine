rm(list = ls())
library(lubridate)
data <-read.csv("01_data/subsample_prop_05_lineage_diversity_VOC.csv")
data$sub_lineage <- data$sub_detla_l
data$sub_richness <- data$sub_detla_r
data$sub_evenness <- data$sub_detla_e
...
data_2022_delta = subset(data,data$year== "2022")
data_2021 <- rbind(data_2021_delta,data_2022_delta)

y4 <- which(data_2021$month=="2021-01") 
y5 <- which(data_2021$month=="2021-02") 
y6 <- which(data_2021$month=="2021-03") 
y7 <- which(data_2021$month=="2022-02") 

data <-data_2021[-c(y4,y5,y6,y7),]
...
model_si <-gam(Y2 ~ Lag(df$Y2,1)+travel_si_cb+gr_cb+npi_si_cb+FBW_si_cb+N+s(C, bs = "re")+P:V,
               method = "REML",family=gaussian,data=df)
summary(model_si)
...
model_gr_rich <- gam(Y1 ~ FBW_gr_cb+richness_gr_cb+npi_gr_cb+travel_gr_cb+N+s(C, bs = "re")+P:V,
                     method = "REML",data=df)
...
model_si_rich <- gam(Y3 ~ Lag(df$Y3,1)+travel_si_cb+npi_si_cb+gr_cb+FBW_si_cb+N+s(C, bs = "re")+P:V,
                     method = "REML",data=df)
...
model_gr_even <- gam(Y1 ~ FBW_gr_cb+evenness_gr_cb+npi_gr_cb+travel_gr_cb+N+s(C, bs = "re")+P:V,
                     method = "REML",data=df)
...
model_si_even <- gam(Y4 ~ Lag(df$Y4,1)+travel_si_cb+npi_si_cb+gr_cb+FBW_si_cb+N+s(C, bs = "re")+P:V,
...
pdf("02_fig/figs14-delta-a-f.pdf", width = 21, height = 21/3*2)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-4, 4), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1,at=0:5*3,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-2:0*2,2:0*2),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
...
mtext(side = 2, at = 4.6, text = "A", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-8, 2), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1,at=0:5*3,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-4:0*2,1:0*2),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nevenness of lineage diversity",side = 2,at=-3, line =4,cex=1.9,family = "ArialN")
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(0, 60), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1,at=0:5*3,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(4:0*15),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=30, line =4,cex=1.9,family = "ArialN")
...
#       lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 81, text = "C", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-9, 3), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*3,1:0*3),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and\nShannon's index of lineage diversity",side = 2,at=-3, line =4,cex=1.9,family = "ArialN")
...
legend("bottomleft",
       ...
       lwd = 3, lty = 1, bty = "n", 
       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 3.6, text = "D", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "Stringency index", ylab = "", main = "", 
     ylim = range(-6, 2), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(1:0*2,-3:0*2),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
legend("bottomleft",
       ...
       lwd = 3, lty = 1, bty = "n", 
       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 2.4, text = "E", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "Stringency index", ylab = "", main = "", 
     ylim = range(-30, 30), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-2:0*15,2:0*15),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=0, line =4,cex=1.9,family = "ArialN")
...
legend("bottomleft",
       ...
       lwd = 3, lty = 1, bty = "n", 
       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 33, text = "F", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
pdf(file="02_fig/figs14-delta-g.pdf",width=7.5,height=7.5)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.axes=axis(4,family = "ArialN",cex.axis=1.8,las=1,seq(-10,0,by=2)),
...
pdf(file="02_fig/figs14-delta-h.pdf",width=7.5,height=7.5)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               family = "ArialN",cex.main=2,cex.lab=1.8,
               key.axes=axis(4,family = "ArialN",cex.axis=1.8,las=1,seq(-1.5,0.5,by=0.5)),
               plot.axes = { axis(1,cex.axis=1.8, at = 0:nlag, c(0:nlag),family = "ArialN") 
                 axis(2,cex.axis=1.8,family = "ArialN",las=3) })
abline(h = 70, lty = 5,lwd=2.5)
...
pdf(file="02_fig/figs14-delta-i.pdf",width=7.65,height=8.4)
...
gr_low_cp <- crosspred(gr_cb,model_si, bylag = 0.1, at=seq(min_gr1,cen_gr1,by=0.1),cen=cen_gr1,cumul=TRUE) 
...
# Plot
#par(mar = c(5, 4, 4, 4))
plot(gr_low_cp,"slices",lag=3,cumul=T,col="black",ylim=c(-30,60),xlim=c(-5,10),axes=F,ann=F,lwd=3,cex.axis=1.9,
...
axis(2,at=c(-1:0*30,2:0*30),cex.axis=1.8,family = "ArialN",las=3,mgp=c(3,1,0))
...
mtext("Effect on Shannon's index of lineage diversity",side = 2,at=15, line =3,cex=1.8,family = "ArialN")
mtext(side = 2, at = 70, text = "I", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
