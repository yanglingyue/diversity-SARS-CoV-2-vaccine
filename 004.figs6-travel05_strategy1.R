...
x1 <- which(data1$month=="2022-04") 
dat_it1 <- data1[x1,c("country","travel_route")]
colnames(dat_it1)[2] <-"travel_route_04" 

x2<- which(data1$month=="2022-06") 
dat_it2 <- data1[x2,c("country","travel_route")]
colnames(dat_it2)[2] <-"travel_route_06" 

x3<- which(data1$month=="2022-05") 
dat_it3 <- data1[x3,]
...
dir.create("02_fig/figs6_travel-05")
outpath <-  "02_fig/figs6_travel-05/figs6-travel-05"
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-3, 2), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1,at=0:5*3,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*1,2:0*1),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
...
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nShannon's index of lineage diversity",side = 2,at=-0.5, line =4,cex=1.7,family = "ArialN")
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-3, 1), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1,at=0:5*3,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*1,1:0*1),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-5,20), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1,at=0:5*3,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-1:0*5,4:0*5),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=7.5, line =4,cex=1.7,family = "ArialN")
...
#       lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.5)
mtext(side = 2, at = 20, text = "C", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "Stringency index", ylab = "", main = "", 
     ylim = range(-12, 4), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*4,1:0*4),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=-4, line =4,cex=1.7,family = "ArialN")
...
p1  <- ggplot(result_vero_shannon,aes(x=coverage, y=vero_fit,group=coverage))+ 
  ...
  scale_y_continuous(limits = c(-1.05,0.5),breaks = c(-1,-0.5,0,0.5))+
  mytheme+
...
ggsave(file=paste0(outpath,"_g",".pdf"),
