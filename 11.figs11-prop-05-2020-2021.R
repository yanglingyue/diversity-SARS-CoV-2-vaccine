model_gr <-  glm(GR_NCM_log_diff ~ npi_gr_cb+FBW_gr_cb+lineage_gr_cb+travel_gr_cb+NPI:F_I_BWP,family=gaussian,data=data_2021)
summary(model_gr)

model_si <-glm(sub_lineage ~ Lag(data_2021$sub_lineage,1)+travel_si_cb+gr_cb+npi_si_cb+FBW_si_cb+NPI:F_I_BWP,family=gaussian,data=data_2021)
summary(model_si)
...
model_gr_rich <- glm(GR_NCM_log_diff ~ FBW_gr_cb+richness_gr_cb+npi_gr_cb+travel_gr_cb+NPI:F_I_BWP,family=gaussian,data=data_2021)
summary(model_gr_rich)

model_si_rich <- glm(sub_richness ~ Lag(data_2021$sub_richness,1)+travel_si_cb+npi_si_cb+gr_cb+FBW_si_cb+NPI:F_I_BWP,family=gaussian,data=data_2021)
...
model_gr_even <- glm(GR_NCM_log_diff ~ FBW_gr_cb+evenness_gr_cb+npi_gr_cb+travel_gr_cb+NPI:F_I_BWP,family=gaussian,data=data_2021)
summary(model_gr_even)

model_si_even <- glm(sub_evenness ~ Lag(data_2021$sub_evenness,1)+travel_si_cb+npi_si_cb+gr_cb+FBW_si_cb+NPI:F_I_BWP,family=gaussian,data=data_2021)
...
pdf("02_fig/figs11-a-f.pdf", width = 21, height = 21/3*2)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-2, 3), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1,at=0:5*3,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-2:0*1,3:0*1),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
...
mtext(side = 2, at = 3.52, text = "A", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-2, 1), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1,at=0:5*3,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-2:0*1,1:0*1),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
legend("bottomleft",
       ...
       lwd = 3, lty = 1, bty = "n", 
       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 1.45, text = "B", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-25, 100), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1,at=0:5*3,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-1:0*25,4:0*25),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=37.5, line =4,cex=1.9,family = "ArialN")
...
legend("bottomleft",
       ...
       lwd = 3, lty = 1, bty = "n", 
       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 105, text = "C", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-5, 1), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-5:0*1,1:0*1),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
#       lwd = 3, lty = 1, bty = "n", 
#      y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 1.42, text = "D", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
#       lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 0.8, text = "E", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "Stringency index", ylab = "", main = "", 
     ylim = range(-8, 40), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-1:0*8,5:0*8),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=16, line =4,cex=1.9,family = "ArialN")
...
#    lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 42, text = "F", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
pdf(file="02_fig/figs11_g.pdf",width=7.5,height=7.5)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.axes=axis(4,family = "ArialN",cex.axis=1.8,las=1,seq(-4,4,by=2)),
...
pdf(file="02_fig/figs11_h.pdf",width=7.5,height=7.57)
par(mar = c(5, 4.5, 4, 3))
...
pdf(file="02_fig/figs11_i.pdf",width=7.65,height=8.4)
...
# Plot
#par(mar = c(5, 4, 4, 4))
plot(gr_low_cp,"slices",lag=3,cumul=T,col="black",ylim=c(-50,50),xlim=c(-5,10),axes=F,ann=F,lwd=3,cex.axis=1.9,
     ci.arg=list(col = grey(0.85)))
lines(gr_high_cp,"slices",lag=3,cumul=T,ci="area",col="black",lwd=3, ci.arg=list(col = grey(0.85)))
abline(h=0,col="black",lty = 3)
axis(1,at=c(seq(-5,10,3)),cex.axis=1.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-2:0*25,2:0*25),cex.axis=1.8,family = "ArialN",las=3,mgp=c(3,1,0))
title(xlab= "Growth rate of cases",cex.lab=1.8,family = "ArialN",line =4)
#mtext("Time lag: 0 months",side = 3,line =1,cex=1.8,family = "ArialN",font=2)
mtext("Effect on Shannon's index\n of lineage diversity",side = 2,at=0, line =4,cex=1.8,family = "ArialN")
mtext(side = 2, at = 55, text = "I", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
dev.off()
