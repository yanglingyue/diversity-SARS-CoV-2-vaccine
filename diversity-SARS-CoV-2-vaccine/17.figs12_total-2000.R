...
pdf("02_fig/total-2000/fig-s12-a-c.pdf", width = 18, height = 6)
...
pdf(file="02_fig/total-2000/Fig-s12-d.pdf",,width=6,height=6)
par(mar = c(5, 4.5, 4, 3))
...
pdf(file="02_fig/total-2000/Fig-s12-e.pdf",width=6,height=6)
par(mar = c(5, 4.5, 4, 3))
