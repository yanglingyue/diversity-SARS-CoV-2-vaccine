...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-4, 2), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1,at=0:5*3,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-2:0*2,1:0*2),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
...
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nShannon's index of lineage diversity",side = 2,at=-1, line =4,cex=1.7,family = "ArialN")
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nevenness of lineage diversity",side = 2,at=-1, line =4,cex=1.7,family = "ArialN")
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-11,22), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1,at=0:5*3,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-1:0*11,2:0*11),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=5.5, line =4,cex=1.7,family = "ArialN")
...
legend("bottomleft",
       ...
       lwd = 3, lty = 1, bty = "n", 
       y.intersp = 1.5, horiz = F,cex=2.5)
mtext(side = 2, at = 26, text = "C", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "Stringency index", ylab = "", main = "", 
     ylim = range(-15, 5), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*5,1:0*5),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=-5, line =4,cex=1.7,family = "ArialN")
...
#    lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.5)
mtext(side = 2, at = 6.5, text = "F", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.axes=axis(4,family = "ArialN",cex.axis=2,las=1,seq(-8,0,by=2)),
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.title=title("",cex.main=2,las=3,family = "ArialN"),
               family = "ArialN",cex.main=2,cex.lab=2,
               key.axes=axis(4,family = "ArialN",cex.axis=2,las=1,seq(-3.2,0.3,by=0.7)),
               plot.axes = { axis(1,cex.axis=2, at = 0:nlag, c(0:nlag),family = "ArialN") 
                 axis(2,cex.axis=2,family = "ArialN") })
abline(h = 70, lty = 5,lwd=2.5)
dev.off()
...
col1 <- rev(brewer.pal(11, "RdBu"))[2]
col2 <- rev(brewer.pal(11, "RdBu"))[10]

# Plot
#par(mar = c(5, 4, 4, 4))
plot(gr_low_cp,"slices",lag=3,cumul=T,col="black",ylim=c(-21,7),xlim=c(-5,10),axes=F,ann=F,lwd=3,cex.axis=2,
     ci.arg=list(col = grey(0.85)))
lines(gr_high_cp,"slices",lag=3,cumul=T,ci="area",col="black",lwd=3, ci.arg=list(col = grey(0.85)))
abline(h=0,col="black",lty = 3)
axis(1,at=c(seq(-5,10,3)),cex.axis=2,family = "ArialN",mgp=c(3,1,0))
axis(2,at=c(-3:0*7,1:0*7),cex.axis=2,family = "ArialN",las=3,mgp=c(3,1,0))
title(xlab= "Growth rate of cases",cex.lab=2,family = "ArialN",line =3)
#mtext("Time lag: 0 months",side = 3,line =1,cex=1.8,family = "ArialN",font=2)
mtext("Effect on lineage diversity",side = 2,at=-7, line =3,cex=2,family = "ArialN")
#par(new=T)
...
######The slice plot of fig.3a#######
pdf(file="02_fig/fig3_a-s1.pdf",width=8,height=8)
par(mar = c(5, 4.5, 4, 3),oma = c(0, 1, 0, 1),family="ArialN")
FI_gr_cp<- crosspred(FBW_gr_cb, model_gr, cen=0,by=0.1,at=0:100,bylag=0.1,cumul=TRUE) #slices

# Plot
#par(mar = c(5, 4, 4, 4))
plot(FI_gr_cp,"slices",lag=2,cumul=T,col="black",ylim=c(-10,0),xlim=c(0,100),axes=F,ann=F,lwd=3,cex.axis=2,
     ci.arg=list(col = grey(0.85)))
#lines(FI_high_gr_cp,"slices",lag=2,cumul=T,ci="area",col="black",lwd=3, ci.arg=list(col = grey(0.85)))
abline(h=0,col="black",lty = 3)
axis(1,at=c(seq(0,100,20)),cex.axis=2,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-5:0*2),cex.axis=2,family = "ArialN",las=1,mgp=c(3,1,0))
title(xlab= "Adjusted vaccine coverage",cex.lab=2,family = "ArialN",line =4)
#mtext("Time lag: 0 months",side = 3,line =1,cex=1.8,family = "ArialN",font=2)
mtext("Effect on growth rate of cases",side = 2,at=-5, line =4,cex=2,family = "ArialN")
#par(new=T)
#hist(data$GR_NCM_log_diff,xlim=c(0,max(y)),ylim=c(0,850),axes=F,ann=F,col=tcol2,breaks=20)
#axis(2,at=c(0:2*160),cex.axis=2,family = "ArialN",line = 1)
#mtext("Frequency",side =2,at=160, line =4,cex=1.8,family = "ArialN")
...
######The slice plot of fig.3b#######
pdf(file="02_fig/fig3_b-s2.pdf",width=8,height=8)
par(mar = c(5, 4.5, 4, 3),oma = c(0, 1, 0, 1),family="ArialN")

FI_si_cp <- crosspred(FBW_si_cb, model_si, cen=0,by=0.1,at=0:100,bylag=0.1,cumul=TRUE) #slices

plot(FI_si_cp ,"slices",lag=2,cumul=T,col="black",ylim=c(-4,1),xlim=c(0,100),axes=F,ann=F,lwd=3,cex.axis=2,
     ci.arg=list(col = grey(0.85)))
#lines(FI_high_gr_cp,"slices",lag=2,cumul=T,ci="area",col="black",lwd=3, ci.arg=list(col = grey(0.85)))
abline(h=0,col="black",lty = 3)
axis(1,at=c(seq(0,100,20)),cex.axis=2,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-4:0*1,1:0*1),cex.axis=2,family = "ArialN",las=1,mgp=c(3,1,0))
title(xlab= "Adjusted vaccine coverage",cex.lab=2,family = "ArialN",line =4)
#mtext("Time lag: 0 months",side = 3,line =1,cex=1.8,family = "ArialN",font=2)
mtext("Effect on lineage diversity",side = 2,at=-1.5, line =4,cex=2,family = "ArialN")
#par(new=T)
#hist(data$GR_NCM_log_diff,xlim=c(0,max(y)),ylim=c(0,850),axes=F,ann=F,col=tcol2,breaks=20)
#axis(2,at=c(0:2*160),cex.axis=2,family = "ArialN",line = 1)
#mtext("Frequency",side =2,at=160, line =4,cex=1.8,family = "ArialN")
mtext(side = 2, at = 17.5, text = "B", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
dev.off()
...
##########The assocition between growth rate of cases and adjusted vaccine coverage######
###################Considering the richness of lineage diversity##################

pdf(file="02_fig/figs16_a2-richness.pdf",width=7.5,height=7.5)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               family = "ArialN",cex.main=2,cex.lab=2,
               key.axes=axis(4,family = "ArialN",cex.axis=1.8,seq(-6,0,by=2)),
...
##########The assocition between the richness of lineage diversity and adjusted vaccine coverage######
pdf(file="02_fig/figs16_a1-richness.pdf",width=7.5,height=7.57)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.title=title("",cex.main=2,las=1,family = "ArialN"),
               family = "ArialN",cex.main=2,cex.lab=2,
               key.axes=axis(4,family = "ArialN",cex.axis=1.8,seq(-64,16,by=16)),
               plot.axes = { axis(1,cex.axis=1.8, at = 0:nlag, c(0:nlag),family = "ArialN") 
                 axis(2,cex.axis=1.8,family = "ArialN") })
abline(h = 70, lty = 5,lwd=2.5)
...
##########The assocition between growth rate of cases and adjusted vaccine coverage######
###################Considering the evenness of lineage diversity##################

pdf(file="02_fig/figs16_b1-evenness.pdf",width=7.5,height=7.5)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.title=title("",cex.main=2,las=1,family = "ArialN"),
               family = "ArialN",cex.main=2,cex.lab=2,
               key.axes=axis(4,family = "ArialN",cex.axis=1.8,seq(-5,0,by=1)),
               plot.axes = { axis(1,cex.axis=1.8, at = 0:nlag, c(0:nlag),family = "ArialN") 
                 axis(2,cex.axis=1.8,family = "ArialN")})
abline(h = 70, lty = 5,lwd=2.5)
mtext(side = 2, at = 110, text = "B", las = 2, cex = 2.5, family = "ArialN",line = 2)
...
##########The assocition between the evenness of lineage diversity and adjusted vaccine coverage######
pdf(file="02_fig/figs16_b2-evenness.pdf",width=7.5,height=7.57)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.title=title("",cex.main=2,las=1,family = "ArialN"),
               family = "ArialN",cex.main=2,cex.lab=2,
               key.axes=axis(4,family = "ArialN",cex.axis=1.8,seq(-1,0.6,by=0.4)),
               plot.axes = { axis(1,cex.axis=1.8, at = 0:nlag, c(0:nlag),family = "ArialN") 
                 axis(2,cex.axis=1.8,family = "ArialN") })
abline(h = 70, lty = 5,lwd=2.5)
#mtext(side = 2, at = 110, text = "B", las = 2, cex = 2.5, family = "ArialN",line = 2)
