...
pdf("02_fig/prop-05/fig_s9-a-c-202009-202112.pdf", width = 18, height = 6)
...
# Plot
#par(mar = c(5, 4, 4, 4))
plot(gr_low_cp,"slices",lag=3,cumul=T,col="black",ylim=c(-50,50),xlim=c(-5,10),axes=F,ann=F,lwd=3,cex.axis=5,
...
axis(2,at=c(-2:0*25,2:0*25),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
...
mtext("Effect on lineage diversity",side = 2,at=0, line =4,cex=1.7,family = "ArialN")
#par(new=T)
...
#mtext(side = 2, at = 18, text = "A", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-2, 3), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1,at=0:5*3,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-2:0*1,3:0*1),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
...
#mtext(side = 2, at = 2.8, text = "B", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-8, 2), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.5,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.5,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-4:0*2,1:0*2),cex.axis=2.5,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
legend("bottomleft",
       ...
       lwd = 3, lty = 1, bty = "n", 
       y.intersp = 1.5, horiz = F,cex=2.5)
#mtext(side = 2, at = 1.6, text = "C", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
pdf(file="02_fig/prop-05/fig_s9-d-202009-202112.pdf",width=6,height=6)
par(mar = c(5, 4.5, 4, 3))
...
pdf(file="02_fig/prop-05/fig_s9-e-202009-202112.pdf",width=6,height=6)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.title=title("",cex.main=1.7,las=1,family = "ArialN"),
               family = "ArialN",cex.main=1.7,cex.lab=1.7,
               key.axes=axis(4,family = "ArialN",cex.axis=1.7,seq(-1.5,4.5,by=1.5)),
               plot.axes = { axis(1,cex.axis=1.7, at = 0:nlag, c(0:nlag),family = "ArialN") 
                 axis(2,cex.axis=1.7,family = "ArialN") })
