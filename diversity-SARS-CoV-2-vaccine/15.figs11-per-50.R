...
pdf("02_fig/per-50/figs11_a-c.pdf", width = 18, height = 6)
...
pdf(file="02_fig/per-50/fig-s11-d.pdf",,width=6,height=6)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               key.axes=axis(4,family = "ArialN",cex.axis=1.7,seq(-4,0,by=1)),
...
pdf(file="02_fig/per-50/fig-s11-e.pdf",width=6,height=6)
par(mar = c(5, 4.5, 4, 3))
