...
#########zero-COVID-19##############
x1 <- which(dat1$country=="China") 
x2 <- which(dat1$country=="Singapore") 
x3 <- which(dat1$country=="South Korea") 
x4 <- which(dat1$country=="Hong Kong") 
x5 <- which(dat1$country=="Australia") 
x6 <- which(dat1$country=="New Zealand") 

#########Afirca##############
x7 <- which(dat1$country=="Egypt") 
x8 <- which(dat1$country=="Nigeria") 
x9 <- which(dat1$country=="Kenya") 
x10 <- which(dat1$country=="South Africa") 

data <-dat1[-c(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10),]


dir.create("02_fig/figs11_remove_country_strategy1")
outpath <-  "02_fig/figs11_remove_country_strategy1/figs11_remove"
...
cp_FI_gr <- crosspred(FBW_gr_cb, model_gr, cen=0,by=0.1,at=0:750/10,bylag=0.1,cumul=TRUE) #slices
...
cp_FI_si <- crosspred(FBW_si_cb, model_si, cen=0,by=0.1,at=0:750/10,bylag=0.1,cumul=TRUE) #slices
...
cp_FI_gr_rich <- crosspred(FBW_gr_cb, model_gr_rich, cen=0,by=0.1,at=0:750/10,bylag=0.1,cumul=TRUE) #slices
...
cp_FI_si_rich <- crosspred(FBW_si_cb, model_si_rich, cen=0,by=0.1,at=0:750/10,bylag=0.1,cumul=TRUE) #slices
...
cp_FI_gr_even <- crosspred(FBW_gr_cb, model_gr_even, cen=0,by=0.1,at=0:750/10,bylag=0.1,cumul=TRUE) #slices
...
cp_FI_si_even <- crosspred(FBW_si_cb, model_si_even, cen=0,by=0.1,at=0:750/10,bylag=0.1,cumul=TRUE) #slices
...
#pdf("02_fig/figs11-remove-country-a-f.pdf", width = 21, height = 21/3*2)
pdf(file=paste0(outpath,"-a-f.pdf"), width = 21, height = 21/3*2)
...
mtext(side = 2, at = 2.35, text = "A", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(-1, 2), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1,at=0:5*3,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-1:0*1,2:0*1),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nevenness of lineage diversity",side = 2,at=0.5, line =4,cex=1.9,family = "ArialN")
...
#       lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 2.35, text = "B", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "International travel", ylab = "", main = "", 
     ylim = range(0, 27), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1,at=0:5*3,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(3:0*9),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=13.5, line =4,cex=1.9,family = "ArialN")
...
#       lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 28.5, text = "C", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     ...
     ylim = range(-3, 0), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*1),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and\nShannon's index of lineage diversity",side = 2,at=-1.5, line =4,cex=1.9,family = "ArialN")
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and\nevenness of lineage diversity",side = 2,at=-1.5, line =4,cex=1.9,family = "ArialN")
...
plot(varby, gr[,lag_gr], col = col1, type = "l", lwd = 3, 
     xlab = "Stringency index", ylab = "", main = "", 
     ylim = range(-18, 0), frame.plot = F, axes = F,family = "ArialN",cex.lab=2.8,line =5)
axis(1, at = 0:5*20, labels = 0:5*20,cex.axis=2.8,family = "ArialN",mgp=c(3,2,0))
axis(2,at=c(-3:0*6),cex.axis=2.8,family = "ArialN",mgp=c(3,1,0))
xx <- c(varby, rev(varby))
yy <- c(gr.lci[,lag_gr], rev(gr.uci[,lag_gr]))
polygon(xx, yy, col = tcol1, border = tcol1)
abline(h = 0, lty = 3)
...
polygon(xx, yy, col = tcol2, border = tcol2)
abline(h = 0, lty = 3)
mtext("Effect on growth rate of cases and \nrichness of lineage diversity",side = 2,at=-9, line =4,cex=1.9,family = "ArialN")
...
#    lwd = 3, lty = 1, bty = "n", 
#       y.intersp = 1.5, horiz = F,cex=2.4)
mtext(side = 2, at = 2.5, text = "F", las = 2, cex = 2.5, family = "ArialN",line = 5.5)
