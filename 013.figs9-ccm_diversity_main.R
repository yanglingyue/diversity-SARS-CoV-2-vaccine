...
data<-read.csv("subsample_prop_05_lineage_diversity.csv")
data1 <- data
#view(data)
...
colnames(data)[26]<-"Growth_Rate"
colnames(data)[29]<-"Shannon"
colnames(data)[17]<-"vaccine"
...
SI_xmap_GR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "Shannon", 
                  ...
                  silent = TRUE)
#1
write.table(GR_xmap_SI[,c(7,9)], file = "D:/YLY/ccm/ccm_results2315/GR_xmap_SI.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table(SI_xmap_GR[,c(7,9)], file = "D:/YLY/ccm/ccm_results2315/SI_xmap_GR.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
...
NPI_xmap_GR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "NPI", 
                   ...
                   silent = TRUE)
write.table( GR_xmap_NPI[,c(7,9)],file="D:/YLY/ccm/ccm_results2315/GR_xmap_NPI.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table( NPI_xmap_GR[,c(7,9)],file="D:/YLY/ccm/ccm_results2315/NPI_xmap_GR.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
...
Vero_xmap_GR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "vaccine", 
                    ...
                    silent = TRUE)
write.table( GR_xmap_Vero[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/GR_xmap_Vero.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table( Vero_xmap_GR[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/Vero_xmap_GR.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
...
Vero_xmap_SI <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "vaccine", 
                    ...
                    silent = TRUE)
write.table( SI_xmap_Vero[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/SI_xmap_Vero.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table( Vero_xmap_SI[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/Vero_xmap_SI.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
...
NPI_xmap_SI <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "NPI", 
                   ...
                   silent = TRUE)
write.table( SI_xmap_NPI[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/SI_xmap_NPI.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table( NPI_xmap_SI[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/NPI_xmap_SI.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
...
abline(h = 0, lty = 3)
####
TR_xmap_GR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "travel2", 
                  target_column = "Growth_Rate", E = best_E["travel2"], lib_sizes = lib_sizes, 
                  silent = TRUE)
GR_xmap_TR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "Growth_Rate", 
                  target_column = "travel2", E = best_E["Growth_Rate"], lib_sizes = lib_sizes, 
                  silent = TRUE)
write.table(  TR_xmap_GR[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/TR_xmap_GR.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table(  GR_xmap_TR[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/GR_xmap_TR.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
TR_xmap_GR_means <- ccm_means(TR_xmap_GR)
GR_xmap_TR_means <- ccm_means(GR_xmap_TR)
par(mar = c(4, 4, 1, 1), mgp = c(2.5, 1, 0)) #
plot(TR_xmap_GR_means$lib_size, pmax(0, TR_xmap_GR_means$rho), type = "l", 
     xlab = "Library Size", ylab = "Cross Map Skill (rho)", col = "red", ylim = c(0, 
                                                                                  1), lwd = 2)
lines(GR_xmap_TR_means$lib_size, pmax(0, GR_xmap_TR_means$rho), col = "blue", 
      lwd = 2)
legend(x = "topleft", col = c("red", "blue"), lwd = 2, legend = c("TR_xmap_GR", 
                                                                  "GR_xmap_TR "), inset = 0.02, bty = "n", cex = 0.8)

abline(h = 0, lty = 3)
####
TR_xmap_SI <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "travel2", 
                  target_column = "Shannon", E = best_E["travel2"], lib_sizes = lib_sizes, 
                  silent = TRUE)
SI_xmap_TR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "Shannon", 
                  target_column = "travel2", E = best_E["Shannon"], lib_sizes = lib_sizes, 
                  silent = TRUE)
write.table(  TR_xmap_SI[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/TR_xmap_SI.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table(  SI_xmap_TR[,c(7,9)],file = "D:/YLY/ccm/ccm_results2315/SI_xmap_TR.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
TR_xmap_SI_means <- ccm_means(TR_xmap_SI)
SI_xmap_TR_means <- ccm_means(SI_xmap_TR)
par(mar = c(4, 4, 1, 1), mgp = c(2.5, 1, 0)) #
plot(TR_xmap_SI_means$lib_size, pmax(0, TR_xmap_SI_means$rho), type = "l", 
     xlab = "Library Size", ylab = "Cross Map Skill (rho)", col = "red", ylim = c(0, 
                                                                                  1), lwd = 2)
lines(SI_xmap_TR_means$lib_size, pmax(0, SI_xmap_TR_means$rho), col = "blue", 
      lwd = 2)
legend(x = "topleft", col = c("red", "blue"), lwd = 2, legend = c("TR_xmap_SI", 
                                                                  "SI_xmap_TR"), inset = 0.02, bty = "n", cex = 0.8)
