...
data <-read.csv("01_data/subsample_prop_05_lineage_diversity_2209.csv")
...
pdf("02_fig/figs13-update-2209-a-f.pdf", width = 21, height = 21/3*2)
...
pdf(file="02_fig/figs13-update-2209-g.pdf",width=7.5,height=7.5)
par(mar = c(5, 4.5, 4, 3))
...
pdf(file="02_fig/figs13_update-2209-h.pdf",width=7.5,height=7.5)
par(mar = c(5, 4.5, 4, 3))
...
filled.contour(x= seq(0, 3, length.out = nrow(z)),
               ...
               family = "ArialN",cex.main=2,cex.lab=1.8,
               key.axes=axis(4,family = "ArialN",cex.axis=1.8,las=1,seq(-2.2,0.3,by=0.5)),
               plot.axes = { axis(1,cex.axis=1.8, at = 0:nlag, c(0:nlag),family = "ArialN") 
                 axis(2,cex.axis=1.8,family = "ArialN",las=3) })
abline(h = 70, lty = 5,lwd=2.5)
...
pdf(file="02_fig/figs13-update-2209-i.pdf",width=7.65,height=8.4)
...
# Plot
#par(mar = c(5, 4, 4, 4))
plot(gr_low_cp,"slices",lag=3,cumul=T,col="black",ylim=c(-18,6),xlim=c(-5,10),axes=F,ann=F,lwd=3,cex.axis=1.9,
