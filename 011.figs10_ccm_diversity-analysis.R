...
rm(list = ls())
setwd("D:/YLY/diversity-2209/vaccine-SARS-CoV-2-diversity")
getwd()
...
dir.create("02_fig/ccm_results2179-final")
outpath <-  "02_fig/ccm_results2179-final/"


data<-read.csv("01_data/subsample_diversity_vaccine_data.csv")
data1 <- data
#view(data)
...
data$NPI <- data$NPI_NV
colnames(data)[9]<-"Growth_Rate"
colnames(data)[13]<-"Shannon"
colnames(data)[7]<-"vaccine"
...
SI_xmap_GR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "Shannon", 
                  ...
                  silent = TRUE)
#1
write.table(GR_xmap_SI[,c(7,9)], file = paste0(outpath,"GR_xmap_SI.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table(SI_xmap_GR[,c(7,9)], file = paste0(outpath,"SI_xmap_GR.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
...
NPI_xmap_GR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "NPI", 
                   ...
                   silent = TRUE)
write.table( GR_xmap_NPI[,c(7,9)],file=paste0(outpath,"GR_xmap_NPI.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table( NPI_xmap_GR[,c(7,9)],file=paste0(outpath,"NPI_xmap_GR.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
...
Vero_xmap_GR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "vaccine", 
                    ...
                    silent = TRUE)
write.table( GR_xmap_Vero[,c(7,9)],file =paste0(outpath,"GR_xmap_Vero.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table( Vero_xmap_GR[,c(7,9)],file = paste0(outpath,"Vero_xmap_GR.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
...
Vero_xmap_SI <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "vaccine", 
                    ...
                    silent = TRUE)
write.table( SI_xmap_Vero[,c(7,9)],file = paste0(outpath,"SI_xmap_Vero.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table( Vero_xmap_SI[,c(7,9)],file = paste0(outpath,"Vero_xmap_SI.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
...
NPI_xmap_SI <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "NPI", 
                   ...
                   silent = TRUE)
write.table( SI_xmap_NPI[,c(7,9)],file =paste0(outpath,"SI_xmap_NPI.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table( NPI_xmap_SI[,c(7,9)],file = paste0(outpath,"NPI_xmap_SI.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
...
GR_xmap_TR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "Growth_Rate", 
                  ...
                  silent = TRUE)
write.table(  TR_xmap_GR[,c(7,9)],file = paste0(outpath,"TR_xmap_GR.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table(  GR_xmap_TR[,c(7,9)],file = paste0(outpath,"GR_xmap_TR.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
...
SI_xmap_TR <- ccm(composite_ts, lib = segments, pred = segments, lib_column = "Shannon", 
                  ...
                  silent = TRUE)
write.table(  TR_xmap_SI[,c(7,9)],file = paste0(outpath,"TR_xmap_SI.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
write.table(  SI_xmap_TR[,c(7,9)],file = paste0(outpath,"SI_xmap_TR.csv"),row.names=FALSE, na="",col.names=FALSE, sep=",")
