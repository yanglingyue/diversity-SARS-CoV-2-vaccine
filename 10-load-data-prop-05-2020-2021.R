...
lag_richness <- tsModel::Lag(data_2021$sub_richness, group = data_2021$country, k = 0:nlag)
lag_evenness <- tsModel::Lag(data_2021$sub_evenness, group = data_2021$country, k = 0:nlag)
