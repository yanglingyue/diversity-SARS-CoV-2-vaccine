setwd("D:/code_upload/vaccine-SARS-CoV-2-diversity/02_fig")
getwd()
rm(list = ls())
# par(mar = c(4,4,2,4))
# par(mfrow = c(3,1))
...
#dir.create("02_fig/remove_country_2208")
outpath <-  "ccm_results2179-final/"

DHS1<- read.csv(paste0(outpath,"GR_xmap_NPI_rho_statistics.csv"),header=FALSE)
DHS2<- read.csv(paste0(outpath,"NPI_xmap_GR_rho_statistics.csv"),header=FALSE)
...
TH1<-ggplot(dfR,aes(x)) +
  ...
  scale_x_continuous(name="Library Size",   limits = c(0, 1500),
                     breaks = seq(0,1500,400),expand = c(0, 0))+
...
DHS1<- read.csv(paste0(outpath,"GR_xmap_Vero_rho_statistics.csv"),header=FALSE)
DHS2<- read.csv(paste0(outpath,"Vero_xmap_GR_rho_statistics.csv"),header=FALSE)
...
DHS1<- read.csv(paste0(outpath,"GR_xmap_TR_rho_statistics.csv"),header=FALSE)
DHS2<- read.csv(paste0(outpath,"TR_xmap_GR_rho_statistics.csv"),header=FALSE)
...
DHS1<- read.csv(paste0(outpath,"SI_xmap_NPI_rho_statistics.csv"),header=FALSE)
DHS2<- read.csv(paste0(outpath,"NPI_xmap_SI_rho_statistics.csv"),header=FALSE)
...
DHS1<- read.csv(paste0(outpath,"SI_xmap_Vero_rho_statistics.csv"),header=FALSE)
DHS2<- read.csv(paste0(outpath,"Vero_xmap_SI_rho_statistics.csv"),header=FALSE)
...
DHS1<- read.csv(paste0(outpath,"SI_xmap_TR_rho_statistics.csv"),header=FALSE)
DHS2<- read.csv(paste0(outpath,"TR_xmap_SI_rho_statistics.csv"),header=FALSE)
...
ggsave(file=paste0(outpath,"fig_s9_ccm.pdf"), plot=e, width=14, height=8.5)
